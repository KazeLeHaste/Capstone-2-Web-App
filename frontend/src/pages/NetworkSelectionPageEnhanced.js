/**
 * Enhanced Network Selection Page Component
 * 
...
const NetworkSelectionPageEnhanced = ({ socket, onLoadingChange }) => {
  ...
  useEffect(() => {
    console.log('NetworkSelectionPageEnhanced: Component mounted');
...
export default NetworkSelectionPageEnhanced;
